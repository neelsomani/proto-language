...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "viii_dna_repair__homologous_recombination__brca1_complex.json")
    output_dir = os.path.join(project_dir, "outputs", "viii_dna_repair__homologous_recombination__brca1_complex")
