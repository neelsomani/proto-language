#!/usr/bin/env python3
"""
Diversification program for: Proteasome - 20S Core (Beta Ring)
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'ii_protein_homeostasis__proteasome__20s_core_beta_ring.json')
    output_dir = os.path.join(project_dir, 'outputs', 'ii_protein_homeostasis__proteasome__20s_core_beta_ring')
