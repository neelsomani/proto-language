#!/usr/bin/env python3
"""
Diversification program for: Translation - 40S Ribosome Subunit
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'i_genetic_info_processing__translation__40s_ribosome_subunit.json')
    output_dir = os.path.join(project_dir, 'outputs', 'i_genetic_info_processing__translation__40s_ribosome_subunit')
