#!/usr/bin/env python3
"""
Diversification program for: T Cell Receptor - Co-receptors & Signaling
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__t_cell_receptor__co_receptors_signaling.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__t_cell_receptor__co_receptors_signaling')
