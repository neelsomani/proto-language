#!/usr/bin/env python3
"""
Diversification program for: Vesicle Trafficking - Clathrin
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "iv_structure_transport__vesicle_trafficking__clathrin.json")
    output_dir = os.path.join(project_dir, "outputs", "iv_structure_transport__vesicle_trafficking__clathrin")
