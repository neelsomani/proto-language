#!/usr/bin/env python3
"""
Diversification program for: RNA Processing - snRNP Core
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "i_genetic_info_processing__rna_processing__snrnp_core.json")
    output_dir = os.path.join(project_dir, "outputs", "i_genetic_info_processing__rna_processing__snrnp_core")
