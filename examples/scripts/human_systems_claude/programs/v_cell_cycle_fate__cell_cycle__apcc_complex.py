#!/usr/bin/env python3
"""
Diversification program for: Cell Cycle - APC/C Complex
Category: V. Cell Cycle & Fate
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'v_cell_cycle_fate__cell_cycle__apcc_complex.json')
    output_dir = os.path.join(project_dir, 'outputs', 'v_cell_cycle_fate__cell_cycle__apcc_complex')
