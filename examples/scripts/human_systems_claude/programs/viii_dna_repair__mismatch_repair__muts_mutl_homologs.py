#!/usr/bin/env python3
"""
Diversification program for: Mismatch Repair - MutS & MutL Homologs
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'viii_dna_repair__mismatch_repair__muts_mutl_homologs.json')
    output_dir = os.path.join(project_dir, 'outputs', 'viii_dna_repair__mismatch_repair__muts_mutl_homologs')
