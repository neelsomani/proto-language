#!/usr/bin/env python3
"""
Diversification program for: Nuclear Pore - Nucleoporins (Nups)
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iv_structure_transport__nuclear_pore__nucleoporins_nups.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iv_structure_transport__nuclear_pore__nucleoporins_nups')
