#!/usr/bin/env python3
"""
Diversification program for: Nucleotide Excision Repair - NER Factors
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'viii_dna_repair__nucleotide_excision_repair__ner_factors.json')
    output_dir = os.path.join(project_dir, 'outputs', 'viii_dna_repair__nucleotide_excision_repair__ner_factors')
