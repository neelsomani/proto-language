#!/usr/bin/env python3
"""
Diversification program for: Transcription - RNA Polymerase II
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'i_genetic_info_processing__transcription__rna_polymerase_ii.json')
    output_dir = os.path.join(project_dir, 'outputs', 'i_genetic_info_processing__transcription__rna_polymerase_ii')
