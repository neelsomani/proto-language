...
def main():
    ...
    config_path = os.path.join(
        project_dir, "configs", "iv_structure_transport__voltage_gated_channels__potassium_channels.json"
    )
    output_dir = os.path.join(
        project_dir, "outputs", "iv_structure_transport__voltage_gated_channels__potassium_channels"
    )
