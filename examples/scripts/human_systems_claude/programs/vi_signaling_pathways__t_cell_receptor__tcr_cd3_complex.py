#!/usr/bin/env python3
"""
Diversification program for: T Cell Receptor - TCR-CD3 Complex
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__t_cell_receptor__tcr_cd3_complex.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__t_cell_receptor__tcr_cd3_complex')
