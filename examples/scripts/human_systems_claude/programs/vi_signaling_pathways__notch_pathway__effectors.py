#!/usr/bin/env python3
"""
Diversification program for: Notch Pathway - Effectors
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__notch_pathway__effectors.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__notch_pathway__effectors')
