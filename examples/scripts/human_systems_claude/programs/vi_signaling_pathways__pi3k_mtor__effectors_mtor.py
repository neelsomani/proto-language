#!/usr/bin/env python3
"""
Diversification program for: PI3K / mTOR - Effectors & mTOR
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__pi3k_mtor__effectors_mtor.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__pi3k_mtor__effectors_mtor')
