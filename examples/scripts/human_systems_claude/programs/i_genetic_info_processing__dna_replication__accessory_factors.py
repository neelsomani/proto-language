#!/usr/bin/env python3
"""
Diversification program for: DNA Replication - Accessory Factors
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'i_genetic_info_processing__dna_replication__accessory_factors.json')
    output_dir = os.path.join(project_dir, 'outputs', 'i_genetic_info_processing__dna_replication__accessory_factors')
