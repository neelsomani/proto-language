#!/usr/bin/env python3
"""
Diversification program for: Homologous Recombination - BRCA2-PALB2-RAD51
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'viii_dna_repair__homologous_recombination__brca2_palb2_rad51.json')
    output_dir = os.path.join(project_dir, 'outputs', 'viii_dna_repair__homologous_recombination__brca2_palb2_rad51')
