#!/usr/bin/env python3
"""
Diversification program for: ATP-dependent Transporters - V-ATPase
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iv_structure_transport__atp_dependent_transporters__v_atpase.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iv_structure_transport__atp_dependent_transporters__v_atpase')
