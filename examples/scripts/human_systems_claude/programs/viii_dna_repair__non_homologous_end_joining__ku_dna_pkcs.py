#!/usr/bin/env python3
"""
Diversification program for: Non-Homologous End Joining - Ku & DNA-PKcs
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'viii_dna_repair__non_homologous_end_joining__ku_dna_pkcs.json')
    output_dir = os.path.join(project_dir, 'outputs', 'viii_dna_repair__non_homologous_end_joining__ku_dna_pkcs')
