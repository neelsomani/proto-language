#!/usr/bin/env python3
"""
Diversification program for: Chromatin Remodeling - NuRD Complex
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vii_chromatin_regulation_and_genome_organization__chromatin_remodeling__nurd_complex.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vii_chromatin_regulation_and_genome_organization__chromatin_remodeling__nurd_complex')
