#!/usr/bin/env python3
"""Diversification program for: PI3K / mTOR - PI3K Complex
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__pi3k_mtor__pi3k_complex.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__pi3k_mtor__pi3k_complex")
