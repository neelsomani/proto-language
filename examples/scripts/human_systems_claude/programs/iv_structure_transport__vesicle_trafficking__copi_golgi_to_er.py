#!/usr/bin/env python3
"""
Diversification program for: Vesicle Trafficking - COPI (Golgi to ER)
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iv_structure_transport__vesicle_trafficking__copi_golgi_to_er.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iv_structure_transport__vesicle_trafficking__copi_golgi_to_er')
