#!/usr/bin/env python3
"""
Diversification program for: Apoptosis - Mitochondrial
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'v_cell_cycle_fate__apoptosis__mitochondrial.json')
    output_dir = os.path.join(project_dir, 'outputs', 'v_cell_cycle_fate__apoptosis__mitochondrial')
