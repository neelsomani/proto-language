#!/usr/bin/env python3
"""Diversification program for: Cytoskeleton - Microtubules
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "iv_structure_transport__cytoskeleton__microtubules.json")
    output_dir = os.path.join(project_dir, "outputs", "iv_structure_transport__cytoskeleton__microtubules")
