#!/usr/bin/env python3
"""Diversification program for: B Cell Receptor - BCR Complex
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__b_cell_receptor__bcr_complex.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__b_cell_receptor__bcr_complex")
