...
with open(
    "examples/scripts/human_systems_claude/outputs/vi_signaling_pathways__b2ar_to_tf_pathway__b2ar_to_tf_pathway/run_20260122_213114_848609/results.json"
) as f:
...
for metric, ylabel in [("plddt", "pLDDT"), ("rmsd", "RMSD (Å)")]:
    for cid in complex_ids:
        ...
        ax.scatter(x, y, c=slate_blue, edgecolors=slate_blue_edge, s=15, alpha=0.7, linewidths=0.3, zorder=2)
