#!/usr/bin/env python3
"""
Diversification program for: NF-kB Pathway - NF-kB Dimers
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__nf_kb_pathway__nf_kb_dimers.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__nf_kb_pathway__nf_kb_dimers")
