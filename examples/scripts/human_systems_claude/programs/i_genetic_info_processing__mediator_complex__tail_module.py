#!/usr/bin/env python3
"""
Diversification program for: Mediator Complex - Tail Module
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'i_genetic_info_processing__mediator_complex__tail_module.json')
    output_dir = os.path.join(project_dir, 'outputs', 'i_genetic_info_processing__mediator_complex__tail_module')
