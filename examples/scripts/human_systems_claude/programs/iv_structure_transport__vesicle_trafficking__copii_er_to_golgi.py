#!/usr/bin/env python3
"""
Diversification program for: Vesicle Trafficking - COPII (ER to Golgi)
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iv_structure_transport__vesicle_trafficking__copii_er_to_golgi.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iv_structure_transport__vesicle_trafficking__copii_er_to_golgi')
