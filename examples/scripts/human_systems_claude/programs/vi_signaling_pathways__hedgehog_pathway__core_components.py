#!/usr/bin/env python3
"""
Diversification program for: Hedgehog Pathway - Core Components
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__hedgehog_pathway__core_components.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__hedgehog_pathway__core_components')
