#!/usr/bin/env python3
"""
Diversification program for: TCA Cycle - Enzymes
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iii_bioenergetics__tca_cycle__enzymes.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iii_bioenergetics__tca_cycle__enzymes')
