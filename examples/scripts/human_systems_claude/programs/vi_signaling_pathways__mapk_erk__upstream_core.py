#!/usr/bin/env python3
"""
Diversification program for: MAPK / ERK - Upstream & Core
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__mapk_erk__upstream_core.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__mapk_erk__upstream_core')
