...
def main():
    ...
    config_path = os.path.join(
        project_dir, "configs", "iv_structure_transport__ligand_gated_channels__glutamate_receptors.json"
    )
    output_dir = os.path.join(
        project_dir, "outputs", "iv_structure_transport__ligand_gated_channels__glutamate_receptors"
    )
