#!/usr/bin/env python3
"""Diversification program for: Hippo Pathway - Kinase Cascade
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__hippo_pathway__kinase_cascade.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__hippo_pathway__kinase_cascade")
