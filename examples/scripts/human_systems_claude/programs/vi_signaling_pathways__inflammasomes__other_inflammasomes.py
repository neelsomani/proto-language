#!/usr/bin/env python3
"""Diversification program for: Inflammasomes - Other Inflammasomes
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__inflammasomes__other_inflammasomes.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__inflammasomes__other_inflammasomes")
