#!/usr/bin/env python3
"""Diversification program for: Wnt / Beta-Catenin - Effectors
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__wnt_beta_catenin__effectors.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__wnt_beta_catenin__effectors")
