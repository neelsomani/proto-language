#!/usr/bin/env python3
"""
Diversification program for: Cell Cycle - CDKs
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'v_cell_cycle_fate__cell_cycle__cdks.json')
    output_dir = os.path.join(project_dir, 'outputs', 'v_cell_cycle_fate__cell_cycle__cdks')
