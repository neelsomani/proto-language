#!/usr/bin/env python3
"""
Diversification program for: DNA Replication - Helicase (CMG Complex)
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'i_genetic_info_processing__dna_replication__helicase_cmg_complex.json')
    output_dir = os.path.join(project_dir, 'outputs', 'i_genetic_info_processing__dna_replication__helicase_cmg_complex')
