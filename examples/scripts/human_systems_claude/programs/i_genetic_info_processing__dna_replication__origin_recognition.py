#!/usr/bin/env python3
"""
Diversification program for: DNA Replication - Origin Recognition
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'i_genetic_info_processing__dna_replication__origin_recognition.json')
    output_dir = os.path.join(project_dir, 'outputs', 'i_genetic_info_processing__dna_replication__origin_recognition')
