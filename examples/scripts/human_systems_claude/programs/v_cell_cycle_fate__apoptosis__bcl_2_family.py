#!/usr/bin/env python3
"""
Diversification program for: Apoptosis - Bcl-2 Family
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "v_cell_cycle_fate__apoptosis__bcl_2_family.json")
    output_dir = os.path.join(project_dir, "outputs", "v_cell_cycle_fate__apoptosis__bcl_2_family")
