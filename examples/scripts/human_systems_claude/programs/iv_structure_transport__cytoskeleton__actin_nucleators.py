#!/usr/bin/env python3
"""
Diversification program for: Cytoskeleton - Actin & Nucleators
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iv_structure_transport__cytoskeleton__actin_nucleators.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iv_structure_transport__cytoskeleton__actin_nucleators')
