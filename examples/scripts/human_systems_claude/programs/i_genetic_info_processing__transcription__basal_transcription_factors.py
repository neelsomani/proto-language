...
def main():
    ...
    config_path = os.path.join(
        project_dir, "configs", "i_genetic_info_processing__transcription__basal_transcription_factors.json"
    )
    output_dir = os.path.join(
        project_dir, "outputs", "i_genetic_info_processing__transcription__basal_transcription_factors"
    )
