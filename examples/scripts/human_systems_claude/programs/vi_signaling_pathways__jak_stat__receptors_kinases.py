#!/usr/bin/env python3
"""
Diversification program for: JAK / STAT - Receptors & Kinases
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__jak_stat__receptors_kinases.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__jak_stat__receptors_kinases')
