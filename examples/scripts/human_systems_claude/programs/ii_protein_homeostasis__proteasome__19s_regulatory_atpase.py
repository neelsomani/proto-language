#!/usr/bin/env python3
"""
Diversification program for: Proteasome - 19S Regulatory (ATPase)
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "ii_protein_homeostasis__proteasome__19s_regulatory_atpase.json")
    output_dir = os.path.join(project_dir, "outputs", "ii_protein_homeostasis__proteasome__19s_regulatory_atpase")
