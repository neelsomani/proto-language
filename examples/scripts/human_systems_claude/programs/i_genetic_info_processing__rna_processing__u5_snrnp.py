...
def add_custom_constraints(
    ...
    # No custom constraints here, but lots in the U5 snRNA program.
...
def main():
    ...
    # This will run after the MCMC optimizer for protein diversification.
    u5_snrna_program = create_u5_snrna_program()
