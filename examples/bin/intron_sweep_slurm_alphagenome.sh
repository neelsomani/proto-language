...
MCMC_PROPOSALS_PER_RESULT="${MCMC_PROPOSALS_PER_RESULT:-1}"
...
run_task() {
    ...
    local cmd=(
        ...
        --mcmc_proposals_per_result "$MCMC_PROPOSALS_PER_RESULT"
    )

    {
        ...
        echo "MCMC_PROPOSALS_PER_RESULT=$MCMC_PROPOSALS_PER_RESULT"
