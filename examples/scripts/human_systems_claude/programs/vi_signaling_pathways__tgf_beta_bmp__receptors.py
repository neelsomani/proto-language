#!/usr/bin/env python3
"""
Diversification program for: TGF-beta / BMP - Receptors
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'vi_signaling_pathways__tgf_beta_bmp__receptors.json')
    output_dir = os.path.join(project_dir, 'outputs', 'vi_signaling_pathways__tgf_beta_bmp__receptors')
