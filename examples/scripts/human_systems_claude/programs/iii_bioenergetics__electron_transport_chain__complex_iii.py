#!/usr/bin/env python3
"""
Diversification program for: Electron Transport Chain - Complex III
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'iii_bioenergetics__electron_transport_chain__complex_iii.json')
    output_dir = os.path.join(project_dir, 'outputs', 'iii_bioenergetics__electron_transport_chain__complex_iii')
