#!/usr/bin/env python3
"""
Diversification program for: ER & Folding - Translocon
...
def main():
    ...
    config_path = os.path.join(project_dir, 'configs', 'ii_protein_homeostasis__er_folding__translocon.json')
    output_dir = os.path.join(project_dir, 'outputs', 'ii_protein_homeostasis__er_folding__translocon')
