#!/usr/bin/env python3
"""Diversification program for: MHC Presentation - MHC Class II
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__mhc_presentation__mhc_class_ii.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__mhc_presentation__mhc_class_ii")
