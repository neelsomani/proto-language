#!/usr/bin/env python3
"""Diversification program for: Inflammasomes - NLRP3 Inflammasome
...
def main():
    ...
    config_path = os.path.join(project_dir, "configs", "vi_signaling_pathways__inflammasomes__nlrp3_inflammasome.json")
    output_dir = os.path.join(project_dir, "outputs", "vi_signaling_pathways__inflammasomes__nlrp3_inflammasome")
