...
class TestMultipleOptimizers:
    ...
    def test_two_optimizers_sequential(self):
        ...
        optimizer1 = TopKOptimizer(
            ...
            config=TopKOptimizerConfig(min_num_samples=10, k=2, batch_size=5),
        )
    ...
    def test_three_optimizers_sequential(self):
        ...
        for i in range(3):
            ...
            optimizer = TopKOptimizer(
                ...
                config=TopKOptimizerConfig(min_num_samples=5, k=1, batch_size=5),
            )
    ...
    def test_state_persistence_between_optimizers(self):
        ...
        optimizer1 = TopKOptimizer(
            ...
            generators=[gen1],
            constraints=[constraint1],
            config=TopKOptimizerConfig(min_num_samples=10, k=1, batch_size=5),
        )
